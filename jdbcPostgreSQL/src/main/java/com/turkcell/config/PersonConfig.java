...
public class PersonConfig {
	// Reponun Db'ye bağlanması için gereken configuration beanleri burada

//	Bu data source bean'i burada yazdığı gibi xml içinde de olabilir. Ben xml içine yazdım.
